...
const searchProducts = async (req, res) => {
    try {
        ...
        res.status(500).render('error',{err:'Error searching products'})
    }
}
...
module.exports = {showAllProducts , productForm , createProduct , showProduct , editProductForm , updateProduct , deleteProduct ,searchProducts}